...
public class AppointmentDao {
	...
	public boolean addAppointment(Appointment ap) {
		...
		try {
			...
			String sql = "insert into appointment(id,user_id,fullname,gender,age,appoint_date,email,phno,disease,doctor_id,address,status) values(?,?,?,?,?,?,?,?,?,?,?,?)";
